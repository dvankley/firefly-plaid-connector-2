...
//                    expectedException: Boolean,
                ...
                Arguments.of(
//                    testName: String,
                    "PFC1 renamed detailed value migration",
//                    input: PersonalFinanceCategory,
                    PersonalFinanceCategory("INCOME", "INCOME_WAGES"),
//                    expectedResult: PersonalFinanceCategoryEnum?,
                    PersonalFinanceCategoryEnum.INCOME_SALARY,
//                    expectedException: Boolean,
                    false,
                ),
                Arguments.of(
//                    testName: String,
                    "PFC1 migration where detailed category moved to a different primary in PFC2",
//                    input: PersonalFinanceCategory,
                    PersonalFinanceCategory("TRANSFER_IN", "TRANSFER_IN_CASH_ADVANCES_AND_LOANS"),
//                    expectedResult: PersonalFinanceCategoryEnum?,
                    PersonalFinanceCategoryEnum.LOAN_DISBURSEMENTS_OTHER_DISBURSEMENT,
//                    expectedException: Boolean,
                    false,
                ),
                Arguments.of(
