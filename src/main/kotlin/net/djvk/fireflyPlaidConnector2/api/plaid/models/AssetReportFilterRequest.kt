 ...
 * @param accountIdsToExclude The accounts to exclude from the Asset Report, identified by `account_id`.
...
data class AssetReportFilterRequest(
    ...
    @field:JsonProperty("account_ids_to_exclude")
    val accountIdsToExclude: kotlin.collections.List<kotlin.String>,
