 ...
 * @param processorToken The processor token obtained from the Plaid integration partner. Processor tokens are in the format: `processor-<environment>-<identifier>`
 * @param type
 * @param network
 ...
 * @param originationAccountId Plaid’s unique identifier for the origination account for this transfer. If you have more than one origination account, this value must be specified.
 */

data class ProcessorBankTransferCreateRequest(
