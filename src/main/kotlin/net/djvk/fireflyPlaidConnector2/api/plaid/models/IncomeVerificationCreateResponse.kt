 ...
 *
 * @param incomeVerificationId ID of the verification. This ID is persisted throughout the lifetime of the verification.
...
data class IncomeVerificationCreateResponse(
    ...
    val incomeVerificationId: kotlin.String,
