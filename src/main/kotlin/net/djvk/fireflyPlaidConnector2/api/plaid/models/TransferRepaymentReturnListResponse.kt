...
data class TransferRepaymentReturnListResponse(

    @field:JsonProperty("repayment_returns")
    val repaymentReturns: kotlin.collections.List<TransferRepaymentReturn>,
