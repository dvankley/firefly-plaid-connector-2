 ...
 *
 * Values: sTORETRANSACTION,uPDATETRANSACTION,dESTROYTRANSACTION
 */

enum class WebhookTrigger(val value: kotlin.String) {

    @JsonProperty(value = "TRIGGER_STORE_TRANSACTION")
    sTORETRANSACTION("TRIGGER_STORE_TRANSACTION"),

    @JsonProperty(value = "TRIGGER_UPDATE_TRANSACTION")
    uPDATETRANSACTION("TRIGGER_UPDATE_TRANSACTION"),

    @JsonProperty(value = "TRIGGER_DESTROY_TRANSACTION")
