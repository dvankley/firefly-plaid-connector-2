 ...
 * @param active If the action is active. Defaults to true.
 * @param stopProcessing When true, other actions will not be fired after this action has fired. Defaults to false.
 */

data class RuleActionStore(

    @field:JsonProperty("type")
    val type: RuleActionKeyword,
