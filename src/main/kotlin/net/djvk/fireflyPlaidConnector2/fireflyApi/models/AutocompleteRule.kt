 ...
 *
 * @param id
 * @param name Name of the rule found by an auto-complete search.
 * @param description Description of the rule found by auto-complete.
 */

data class AutocompleteRule(
