 ...
 * @param documentMetadata Metadata for an income document.
 * @param error
 */

data class IncomeVerificationPaystubsGetResponse(

    @field:JsonProperty("paystubs")
    val paystubs: kotlin.collections.List<Paystub>,
    ...
    val documentMetadata: kotlin.collections.List<DocumentMetadata>? = null,
