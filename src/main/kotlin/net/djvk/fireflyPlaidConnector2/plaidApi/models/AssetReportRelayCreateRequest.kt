 ...
 * @param secondaryClientId The `secondary_client_id` is the client id of the third party with whom you would like to share the Asset Report.
 ...
 * @param webhook URL to which Plaid will send webhooks when the Secondary Client successfully retrieves an Asset Report by calling `asset_report/relay/get`.
 */

data class AssetReportRelayCreateRequest(
