 ...
 *
 * @param paymentToken A `payment_token` that can be provided to Link initialization to enter the payment initiation flow
 * @param paymentTokenExpirationTime The date and time at which the token will expire, in [ISO 8601](https://wikipedia.org/wiki/ISO_8601) format. A `payment_token` expires after 15 minutes.
...
data class PaymentInitiationPaymentTokenCreateResponse(
    ...
    val paymentToken: kotlin.String,
    ...
    @field:JsonProperty("payment_token_expiration_time")
    val paymentTokenExpirationTime: java.time.OffsetDateTime,
