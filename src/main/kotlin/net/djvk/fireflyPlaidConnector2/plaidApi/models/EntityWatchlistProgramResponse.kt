 ...
 *
 * @param id ID of the associated entity program.
 ...
 * @param name A name for the entity program to define its purpose. For example, \"High Risk Organizations\" or \"Applicants\".
...
data class EntityWatchlistProgramResponse(
    ...
    val listsEnabled: kotlin.collections.List<EntityWatchlistCode>,
