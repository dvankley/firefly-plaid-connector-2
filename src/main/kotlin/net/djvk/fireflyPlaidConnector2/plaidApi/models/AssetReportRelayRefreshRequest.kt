 ...
 * @param webhook The URL registered to receive webhooks when the Asset Report of a Relay Token has been refreshed.
 */

data class AssetReportRelayRefreshRequest(
