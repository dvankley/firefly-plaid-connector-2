 ...
 *
 * Values: investment,credit,depository,loan,payroll,other
 */

enum class OverrideAccountType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is OverrideAccountType) "$data" else null

        /**
         * Returns a valid [OverrideAccountType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): OverrideAccountType? = data?.let {
