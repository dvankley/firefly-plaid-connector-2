 ...
 *
 * @param id Plaid’s unique identifier for a transfer.
 * @param achClass
 * @param accountId The account ID that should be credited/debited for this transfer.
 * @param type
 * @param user
 ...
 * @param created The datetime when this transfer was created. This will be of the form `2006-01-02T15:04:05Z`
 * @param status
 * @param network
 * @param cancellable When `true`, you can still cancel this transfer.
 * @param failureReason
...
data class Transfer(
    ...
    @field:JsonProperty("sweep_status")
    val sweepStatus: TransferSweepStatus? = null
