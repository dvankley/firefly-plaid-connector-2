 ...
 * @param personalFinanceCategory Personal finance detailed category.  See the [`taxonomy csv file`](https://plaid.com/documents/transactions-personal-finance-category-taxonomy.csv) for a full list of personal finance categories.
 * @param ruleDetails
 */

data class TransactionsRulesCreateRequest(
    ...
    val personalFinanceCategory: kotlin.String,

    @field:JsonProperty("rule_details")
    val ruleDetails: TransactionsRuleDetails
